...
async def run():
    ...
    try:
        ...
        print("✓ Test 1: initial deposits = $0.00")
        ...
        print(f"✓ Test 2: summed deposits = ${total:.2f}")
        ...
        print(f"✓ Test 3: get_deposits newest-first OK")
        ...
        print(f"✓ Test 4: load_from_db uses deposits: bankroll=${float(risk.current_bankroll):.2f}")
        ...
        print(f"✓ Test 5: add_funds: ${before:.2f} → ${after:.2f}")
        ...
        try:
            ...
            print("✓ Test 6: add_funds rejects zero correctly")
        ...
        try:
            ...
            print("✓ Test 7: add_funds rejects negative correctly")
        ...
        print(f"✓ Test 8: add_funds persisted to DB, {len(all_deposits)} deposits total")

        # Test 9: CORS middleware exists and is importable
        from src.control.api import cors_middleware, ControlAPI
        print("✓ Test 9: cors_middleware and ControlAPI import OK")
        ...
        print("✓ Test 10: ControlAPI has _add_funds and _funds_history methods")
